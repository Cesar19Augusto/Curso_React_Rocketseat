...
//Já que o useState retorno também um aray e uma função foi usado o conceito de desestruturação 
    ...
    const publishedDateFromatted = format(post.publishedAt, "d 'de' LLLL 'às' HH:mm'h'", {
        locale: ptBR,
    })
    ...
    return (
        <article className={styles.post}>
            <header>
                ...
                <time title={publishedDateFromatted} dateTime={post.publishedAt.toISOString()}> {publishedDateRelativeToNow} </time>
            </header> 
